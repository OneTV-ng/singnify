...
/**
 * Interface for InputField and SelectField props.
 * 'options' is specific to SelectField but is included here as InputField also extends HTMLInputElement attributes.
 * This makes the interface more flexible for both components.
 */
interface InputFieldProps extends React.InputHTMLAttributes<HTMLInputElement> {
  ...
  options?: { value: string; label: string }[] | string[]; // Added for SelectField
}
...
const SelectField = React.memo((
  { value, onChange, options, placeholder, error }: InputFieldProps
) => (
  <div className="relative">
    <select
      value={value}
