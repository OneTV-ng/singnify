...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Add API key - try both methods based on your curl example
    formDataObj.append('API_KEY', AUTH_CONSTANTS.API_KEY);

    console.log('Submitting form data:', Object.fromEntries(formDataObj));

    try {
      // Updated URL to include API_KEY as query parameter (matching your curl example)
      const url = `https://singnify.com/api/v2/php/register.php?API_KEY=${AUTH_CONSTANTS.API_KEY}`;
