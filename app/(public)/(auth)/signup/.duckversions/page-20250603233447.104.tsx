  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestBody = {
        ...
        API_KEY: '7c6a180b36896a0a8c02787eeafb0e4c'
      };

      console.log('Submitting registration data:', requestBody);

      const response = await fetch('https://singnify.com/api/v2/php/register.php?API_KEY=7c6a180b36896a0a8c02787eeafb0e4c', {
        method: 'POST',
        headers: {
