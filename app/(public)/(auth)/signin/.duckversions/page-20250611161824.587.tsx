...
/**
 * Memoized InputField component for perfÅormance.
 * Reused from your RegisterPage.
 * @param {object} props - Component props (type, placeholder, value, onChange, error, etc.)
 */
const InputField = React.memo(({ type = 'text', placeholder, value, onChange, error, ...props }) => (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <InputField
                ...
                icon={<Mail className="w-5 h-5 text-gray-400 absolute left-4 top-1/2 -translate-y-1/2" />}
              />
            </div>
            <div className="relative">
              <InputField
                ...
                icon={<Lock className="w-5 h-5 text-gray-400 absolute left-4 top-1/2 -translate-y-1/2" />}
              />
              <button
                type="button"
