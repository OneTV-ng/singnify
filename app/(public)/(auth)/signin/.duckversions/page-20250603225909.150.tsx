...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create FormData object (matching the login function pattern)
      ...
      formDataObj.append('is_artist', formData.is_artist.toString());
      formDataObj.append('stage_name', formData.stage_name);
      formDataObj.append('record_label', formData.record_label);
      formDataObj.append('about', formData.about);
      formDataObj.append('uname', formData.uname);
      formDataObj.append('ref_code', formData.ref_code);
     //formDataObj.append('API_KEY', AUTH_CONSTANTS.API_KEY);
     formDataObj.append('API_KEY', '7c6a180b36896a0a8c02787eeafb0e4c');

      console.log('Submitting registration data:', Object.fromEntries(formDataObj));
