...
//const mis ="fanlinks":
  //  {
   //   "spotify": "https://open.spotify.com/track/3BCoM1Bg5Ig3rSDbjSlTAO",
   //   //  "apple": "https://music.apple.com/us/album/abi-na-no-mans-land/1846152097?i=1846152102&uo=4",
//         "youtube": "https://www.youtube.com/results?search_query=1community%20Abi%20na%20no%20mans%20land%20official%20audio",
  //     "youtube_music": "https://music.youtube.com/search?q=1community%20Abi%20na%20no%20mans%20land%20official%20audio",
 //    }
  //   */
...
const platforms = [
  ...
  { key: "apple", label: "Apple Music", icon: <SiApplemusic />, color: "bg-[#fa57c1]" },
  { key: "apple_music", label: "Apple Music", icon: <SiApplemusic />, color: "bg-[#fa57c1]" },
  { key: "youtube_music", label: "YouTube Music", icon: <SiYoutube />, color: "bg-[#FF0000]" },
    { key: "youtube", label: "YouTube Music", icon: <SiYoutube />, color: "bg-[#FF0000]" },

  { key: "deezer", label: "Deezer", icon: <FaDeezer />, color: "bg-[#a238ff]" },
  { key: "tidal", label: "Tidal", icon: <SiTidal />, color: "bg-[#0A0A0A]" },
  { key: "audiomack", label: "Audiomack", icon: <SiAudiomack />, color: "bg-[#f6b21d]" },
  { key: "amazon_music", label: "Amazon Music", icon: <SiAmazonmusic />, color: "bg-[#FF9900]" },
{ key: "amazon", label: "Amazon Music", icon: <SiAmazonmusic />, color: "bg-[#FF9900]" },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-neutral-900 to-black text-white flex flex-col items-center py-10 px-6">
      <div className="max-w-sm w-full text-center">
        <div className="relative w-52 h-52 mx-auto mb-6 rounded-lg overflow-hidden shadow-lg shadow-amber-500/30">
