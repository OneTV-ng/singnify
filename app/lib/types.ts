...
export type AlbumType ={
  ...
  artist: string;          // The artist/band who created the album
  releaseDate: string;     // The release date of the album (can be a string in 'YYYY-MM-DD' format)
  coverArt: string;        // URL to the album cover art image
  genre: string;           // Genre of the album (e.g., 'Rock', 'Pop', 'Hip-Hop')
  trackCount?: number;      // Number of tracks in the album
  tracks?: string[];        // Array of track names
  duration?: string;        // Duration of the album (in format 'HH:MM:SS')
  label?: string;           // The record label that released the album (can be null or empty)
  isExplicit?: boolean;     // Whether the album is marked as explicit content
