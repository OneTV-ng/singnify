        ...
        <div>
          ...
          <p className="text-sm text-gray-400">
            {isVerified === '1' ? 'Your account is verified' : 
             isVerified === '0' ? 'Verification in progress' :      <Link href="/member/verify" className="text-blue-400 underline">
              Click Here to Complete verification to unlock all features
            </Link>}
          </p>
        </div>
      </div>
