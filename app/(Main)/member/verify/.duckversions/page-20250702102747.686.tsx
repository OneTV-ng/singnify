...
const handleSubmit = async () => {
  ...
  form.append('paypal_email', formData.paypal_email || '');
  form.append('social_media_accounts', formData.social_media_accounts || '');
  ...
  try {
    ...
    const result = await response.text(); // or .json() if the API returns JSON
