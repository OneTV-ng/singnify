...
import ImageUploadComponent from "@/app/components/singfle/ImageUploadComponent"
...
// Function to collect social media URLs
  ...
  <Image 
          src={formData.Picture||formData?.Avatar || "/assets/images/ProfilePictures/default-avatar.png"}
                  alt={user?.FirstName}
 ...
 //apiKey="your-key"
  ...
  onChange={(url, resp) => {
    // url and response are properly typed
 console.log(resp);console.log(url):

    if(url){
     handleInputChange = (field:'Picture', value: url);
