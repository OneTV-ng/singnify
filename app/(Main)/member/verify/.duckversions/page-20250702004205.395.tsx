...
// Function to collect social media URLs
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      <Image
        src={formData?.picture || formData?.avata || "/assets/images/ProfilePictures/default-avatar.png"}
      ...
      <ImageUploadComponent  
       value={formData?.picture || formData?.avata || "/assets/images/ProfilePictures/default-avatar.png"}
