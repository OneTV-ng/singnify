...
import UploadWelcome from '@/app/components/UploadWelcome';
...
const MusicSubmissionForm: React.FC = () => {
  ...
  const steps: Step[] = [
    { id: 1, title: 'Welcome', icon:  Music,},
    { id: 2, title: 'Requirements', icon: Calendar },
    { id: 3, title: 'Submission Type', icon: Disc },
    { id: 4, title: 'Track Info', icon: Music },
    { id: 5, title: 'Media Upload', icon: Upload },
    { id: 6, title: 'Artist Details', icon: User },
    { id: 7, title: 'Additional Info', icon: FileText },
    { id: 8, title: 'Review & Submit', icon: Check }
  ];

const requirements = [
  'Album cover must be a perfect square (JPG, PNG, or TIFF), 3000x3000 pixels, and between 3000–4000 pixels in size.',
  'Artwork should be clean — no social media logos, brand logos, or unrelated text.',
  'Audio files must be high-quality MP3, WAV, or FLAC, at least 90 seconds long, 44.1kHz, 16-bit stereo.',
  'Provide Track Name, Artist Name, Genre, and a 40-word description of your song for promotion.',
  'Enter Spotify and iTunes URLs (optional).',
  'Select your music’s release date.',
  'Paste or upload your lyrics (optional).',
  'By uploading, you agree to make your music available for at least 6-12 months, or pay a $50 or more takedown fee.',
  'Include a one-minute promo video (H.264 video + AAC audio) for social media distribution.',
];
 ...
 if (currentStep === 1) {
      if (!agreed) {
        isValid = false;
        errorMsg = 'you MUST! - Agree to our terms before you can proceed.';
        console.error('❌ Validation Failed: Trems not yet Agreed');
      } else {
        console.log('✅ Step 1 validated:Terms and Copyrights agreed  =', agreed);
      }
      ...
      if (!submissionType) {
        ...
        console.log('✅ Step 3 validated: Submission type =', submissionType);
      }
      ...
      if (submissionType === 'single') {
        ...
        if (missingFields.length > 0) {
          ...
          console.log('✅ Step 4 validated: All single track fields complete');
        }
      } else {
        ...
        }else if (!formData.description?.trim() || formData.description.trim().split(/\s+/).length < 40) {
  isValid = false;
  errorMsg = 'Description of Son in not less than 40 words is required.';
  console.error('❌ Validation Failed: Description too short (less than 40 words)');
} else {
          ...
          if (!trackValidationFailed) {
            console.log('✅ Step 4 validated: All album fields and track names complete');
          }
        }
      }
      ...
      if (!formData.first_name || !formData.last_name || !formData.contact_phone) {
        ...
        console.log('✅ Step 6 validated: Artist details complete');
      }
    }
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6 animate-fade-in-up">
            <h2 className="text-2xl font-bold text-white mb-6">Welcome to your Music Jouney!</h2>
            <h2 className="text-2xl font-bold text-green-400 mb-4 text-center">
         Uphold Copyrights Integrity!!!
        </h2>
        ...
        <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
          ...
          <li>Express Take-Down Request (songs less than 6 - 12 months) Will attract a Handling and processing $ FEE.</li>
          <li>For collaborations, ensure all contributors agree to the upload and terms.</li>
          <li>Review our full <a href="/terms" className="text-blue-400 hover:underline">Terms of Service</a> and <a href="/privacy" className="text-blue-400 hover:underline">Privacy Policy</a>.</li>
          <li>By proceeding, you agree to comply with these guidelines and uphold copyright integrity.</li>
      ...
      case 4:
        return (
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div>
              <label className="block text-sm font-medium text-white mb-2">Description - (minimun 40 words) <span className="text-red-400">*</span></label>
              <textarea
