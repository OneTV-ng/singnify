...
const ArtistRecordsPage = async () => {
  ...
  const [successMessage, setSuccessMessage] = useState<string | null>(null);
    ...
    const [hsash, setHash] = useState <null|string>("");
      ...
      switch (tab) {
        ...
        default:
          endpoint = 'https://singnify.com/api/v2/php/get-user-profile.php';
           ...
           formData.append('table_name', tab);

//const eendpoint = "https://singnify.com/api/v2/php/view-record.php/";
...
//console.log(eendpoint, token,  userId,  "table_name =" + hash||tname   );
  ...
  const renderActiveTab = () => {
   // const ash = (!lastcall) ? getHash():null;
