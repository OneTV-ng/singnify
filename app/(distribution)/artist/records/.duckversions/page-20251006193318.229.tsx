    ...
    try {
      ...
      switch (tab) {
        ...
        case 'tracks':
          ...
          break;
        case 'albums':
          endpoint = 'https://singnify.com/api/v2/php/user-albums.php';
          break;
        case 'playlist':
          endpoint = 'https://singnify.com/api/v2/php/user-playlists.php';
          break;
        case 'liked':
          endpoint = 'https://singnify.com/api/v2/php/user-likes.php';
          break;
        case 'following':
          endpoint = 'https://singnify.com/api/v2/php/user-following.php';
          break;
        default:
          endpoint = 'https://singnify.com/api/v2/php/get-user-profile.php';
      }
      ...
      const response = await fetch(`${eendpoint}?API_KEY=7c6a180b36896a0a8c02787eeafb0e4c`, {
        method: 'POST',
        body: formData,
      });
