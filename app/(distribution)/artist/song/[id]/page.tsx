...
const API_CONFIG = {
  ...
  getRecord: 'https://singnify.com/api/v2/php/view-record.php',
};
...
type TabType = 'songs' | 'albums' | 'about'|'playlist'|'likes'|'press';
  ...
  const fetchTrack = async () => {
    ...
    try {
      ...
      formData.append('table_name', 'music' );
...
console.log('Fetching record with Respont:', respont);
     // console.log('Fetching record with Respont:', respont.responseText);
