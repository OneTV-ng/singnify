...
const MusicSubmissionForm: React.FC = () => {
  ...
  const handleFileUpload = async (field: 'audio' | 'image' | 'lyrics_file', file: File | null): Promise<void> => {
    if (!file) return;
    ...
    const interval = setInterval(() => {
      ...
      if (progress >= 100) {
        ...
        if (field === 'audio') {
          ...
          calculateAudioDuration(file).then(duration => {
